...
# Canonical: ~/.claude/skills/cb-lib/hooks/cb-worklog-check.sh (kept current by cb-workflow bin/sync).
set -euo pipefail
canonical="${HOME:-}/.claude/skills/cb-lib/hooks/cb-worklog-check.sh"
if [ ! -r "$canonical" ]; then
